...
# # Key Vault Access for the Frontend app
# resource "azurerm_role_assignment" "assign-access-to-frontend-app" {
#   principal_id              = azurerm_linux_web_app.azure-waf-manager.identity[0].principal_id
...
#   administrator_login          = "Djongov"
#   administrator_password       = "pb9fp2OOQR9J50TGh8jL"
